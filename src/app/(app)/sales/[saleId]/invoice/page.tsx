...
export default function InvoicePage() {
    ...
    const currentFontSize = fontSizes[store?.ticketFontSize as keyof typeof fontSizes] || fontSizes.sm;
    const headerFontSize = store?.ticketFontSize === 'lg' ? 'text-lg' : 'text-base';
    ...
    return (
        <main className="flex-1 p-2 md:p-8 flex flex-col items-center bg-gray-100 min-h-screen">
            <div className="w-full max-w-sm space-y-4 print:max-w-none print:w-full print:m-0 print:p-0">
                ...
                <Card className={cn(
                    "p-2 md:p-3 shadow-xl print:shadow-none print:border-none print:p-0 bg-white text-black card-pos-thermal font-mono",
                    currentFontSize
                )}>
                    {/* CABECERA COMPACTA */}
                    <div className="flex flex-col border-b border-black pb-1 text-center uppercase">
                        <h1 className={cn("font-black leading-tight", headerFontSize)}>{store?.name || 'KREA BUSINESS'}</h1>
                    ...
                    {/* CONTROL Y FECHA */}
                    <div className="flex flex-col gap-0 border-b border-black py-0.5 text-[0.8em] font-bold">
                    ...
                    {/* CLIENTE */}
                    <div className="flex flex-col border-b border-black py-0.5 text-[0.8em] font-bold">
                    ...
                    {/* CABECERA DE TABLA */}
                    <div className='mt-1'>
                        <div className='grid grid-cols-12 text-[0.9em] font-black uppercase border-b border-black pb-0.5 mb-1'>
                        ...
                        <div className="space-y-0.5">
                            {sale.items.map((item: any, idx: number) => (
                                <div key={idx} className='grid grid-cols-12 font-bold leading-tight'>
                    ...
                    {/* PIE DE PAGINA */}
                    <div className="mt-2 border-t border-black pt-1 text-center text-[0.8em] font-bold uppercase space-y-0.5">
                        ...
                        <p className="text-[0.6em] opacity-60 mt-1 italic">PROCESADO POR KREA BUSINESS SUITE</p>
                    </div>
                </Card>
            </div>
