...
const productSchema = z.object({
  ...
  minStock: z.coerce.number().min(0, 'El stock mínimo no puede ser negativa.'),
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <FormField control={form.control} name="name" render={({ field }) => (
                          <FormItem className='md:col-span-2'>
                            ...
                            <FormControl><Input className="h-11 text-base font-bold rounded-xl border-slate-200" {...field} value={field.value ?? ''} /></FormControl>
                          </FormItem>
                        )} />
                        
                        <FormField control={form.control} name="category" render={({ field }) => (
                            <FormItem><FormLabel className='text-[10px] font-black uppercase text-slate-500'>Categoría</FormLabel>
                            <FormControl><Input className="h-11 font-bold rounded-xl border-slate-200" {...field} value={field.value ?? ''} /></FormControl></FormItem>
                        )} />
                            ...
                            <div className="flex gap-2">
                                <FormControl>
                                    <div className="relative flex-1 group">
                                        ...
                                        <Input className="h-12 pl-11 font-mono font-bold rounded-xl border-slate-200" {...field} value={field.value ?? ''} />
                                    </div>
                                </FormControl>
